...
unit tests passed at 36/36 after adding fail-fast checks for the Transformer
controls, incremental AST configuration checks, opt-in CVD audit coverage, and
validated-pipeline input range controls.  The data-pipeline preflight also
