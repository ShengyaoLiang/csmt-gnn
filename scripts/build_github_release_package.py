...
RESULT_FILES = [
    ...
    "results/diagnostic_seed_sweep_1_5.json",
    "results/diagnostic_seed_sweep_1_5.md",
    "results/diagnostic_poc_cvd_control_seed1.json",
    "results/diagnostic_poc_cvd_control_seed2.json",
    "results/diagnostic_poc_cvd_control_seed3.json",
    "results/diagnostic_poc_cvd_control_seed4.json",
    "results/diagnostic_poc_cvd_control_seed5.json",
    "results/diagnostic_cvd_control_1_5.json",
    "results/diagnostic_cvd_control_1_5.md",
